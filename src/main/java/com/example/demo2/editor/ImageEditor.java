package com.example.demo2.editor;

import com.example.demo2.shapes.CompoundShape;
import com.example.demo2.shapes.Shape;
            ...
            addKeyListener(new KeyAdapter() {
                ...
                public void keyTyped(KeyEvent e) {
                    if (e.getKeyChar() == 'f') { //front
                        ...
                        e.getComponent().repaint();
                    } else if (e.getKeyChar() == '+') { //sizeup
                        Shape b = allShapes.getSelected();
                        if (b != null) {
                            allShapes.sizeplus(b);
                        }
                        e.getComponent().repaint();
                    } else if (e.getKeyChar() == '-') { //sizedown
                        Shape b = allShapes.getSelected();
                        if (b != null) {
                            allShapes.sizeminus(b);
                        }
                        e.getComponent().repaint();
                        ...
                        try {
                            ImageIO.write(img, "png", new File("C:/img/test.png"));
                            ImageIO.write(img, "JPEG", new File("C:/img/test.JPG"));
